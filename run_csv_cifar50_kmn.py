...
if __name__ == "__main__":
    ...
    if dataset == 'mnist':
        ...
        img_rows, img_cols = 28, 28
         ...
         train_path =('/content/drive/My Drive/deep/deepimportance/sample_data/CIFAR100_snow_brightness_60_class50.csv')
         train_path2=('/content/drive/My Drive/deep/deepimportance/sample_data/CIFAR100_Train3000_class50.csv')
         ...
         X_test = np.zeros((1000,32,32,3))  #sample data_set   cifar10, cifar100 : (1000, 32, 32, 3)  mnist : (1000 , 28, 28, 1)  STL10 : (100, 96, 96, 3)

         X_train = np.zeros((3000,32,32,3))
         ...
         for k in range(0, 3073000):
           if k % 3073==0:   # 3073 = 32* 32 * 3 +1  / 28*28 +1 = 785
             data_num = data_num + 1
             data_width = 0
             data_height = 0
             data_channel = 0
           ...
           elif data_height == 31 and data_width ==32:  # height 32  channel 
             data_width = 0
             data_height = 0
           ...
           elif data_width ==32: # width 32 height 
             data_width = 0
    ...
    #model_name = 'cifar10_resnet_32_model'
    ...
    if approach == 'nc':
        ...
        dg = DeepGaugePercentCoverage(model, k_sect, X_test, None, skip_layers) ##
