...
if __name__ == "__main__":
    ...
    if dataset == 'mnist':
        ...
        img_rows, img_cols = 28, 28
         ...
         train_path =('/content/drive/My Drive/deep/deepimportance/sample_data/CIFAR100_snow_rain_class50.csv')
    ...
    model_name = 'content/drive/My\ Drive/deep/deepimportance/neural_networks/cifar100_resnet_32_epcch120_class50_model'
