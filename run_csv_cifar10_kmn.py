...
if __name__ == "__main__":
    ...
    if dataset == 'mnist':
        ...
        img_rows, img_cols = 28, 28
         ...
         train_path =('/content/drive/My Drive/deep/deepimportance/sample_data/cifar10_snow_zoom_1.2.csv')
         
         train_path2=('/content/drive/My Drive/deep/deepimportance/sample_data/cifar10_train3000.csv')
